...
examples: test serial step fbuf interp video
...
examples/test.o examples/serial.o examples/step.o examples/fbuf.o examples/interp.o examples/video.o : CXXFLAGS+=-std=c++11

test serial step fbuf interp video hotspot : CXXFLAGS+=-I. -std=c++11
